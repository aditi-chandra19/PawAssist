...
const services = [
  {
    id: "vet-visit",
    name: "Vet Visit",
    description: "Video or in-home consult for symptoms, appetite changes, and routine advice.",
    category: "Health",
    price: 699,
    eta: "15 mins",
    accent: "#f97316",
  },
  {
    ...
    description: "Bath, trim, coat conditioning, nail clipping, and gentle drying.",
    category: "Care",
    price: 899,
    eta: "35 mins",
    accent: "#0f766e",
  },
  {
    id: "training",
    name: "Trainer Visit",
    description: "Behavior coaching for leash pulling, barking, recall, and home manners.",
    category: "Training",
    price: 1099,
    eta: "45 mins",
    accent: "#1d4ed8",
  },
  {
    id: "ambulance",
    name: "Pet Ambulance",
    description: "Rapid transport with first-response support to your nearest partner clinic.",
    category: "Emergency",
    price: 1499,
    eta: "10 mins",
    accent: "#dc2626",
